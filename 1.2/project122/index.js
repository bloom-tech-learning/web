...
console.log(var1);
  ...
  console.log('something might wrong in this case');
}
...
let numberVar = Number(stringVar);
...
// function hungryDog(/*add your code here*/){
  function hungryDog(weight, dogAge){
      /*add your code here*/
      if (weight >= 15 && dogAge >= 1) {
            return weight * 0.02;
      } else if (weight >=11 && weight <= 15 && dogAge >= 1) {
              return weight * 0.03;
      } else if ( weight >= 6 && weight <= 10 && dogAge >= 1) {
              return weight*0.04;
      } else if (weight <= 5 && dogAge >= 1){
              return weight * 0.05;
          ...
          console.log('Hi mate, my tutor do not mention that cases')
      }
  }
...
2. Convert the number of kilometer received to miles
...
// function feet(/*add your code here*/){
  function feet(lengthInCm){
    /*add your code here*/
    return lengthInCm / 30.48;
  }
