...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "/Users/rongjun-geng/lambdaAssignments/web/2.1/project214/video",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"GitHubCard/index.js":[function(require,module,exports) {
"use strict";
...
var grabTheData = function grabTheData(URL) {
  _axios.default.get(URL).then(function (res) {
    ...
    var gitCard = gitCardMaker(gitObj);
    document.querySelector('.cards').appendChild(gitCard);
  }).catch(function (err) {
    return console.error(err);
  }).finally(function () {
    return console.log("I DON'T CARE IF IT WORKED OR NOT!!!");
  }); // post() patch() delete()     
...
for (var i = 0; i < followersArray.length; i++) {
  urlArr.push("https://api.github.com/users/".concat(followersArray[i]));
} // urlArr.forEach(item => grabTheData(item));


urlArr.map(function (item) {
  return grabTheData(item);
});
/*
...
function gitCardMaker(gitObj) {
  ...
  var bio = document.createElement('p'); // setting class names, attributes and text

  bio.textContent = "Bio: ".concat(gitObj.bio);
  following.textContent = "Following: ".concat(gitObj.following);
  followers.textContent = "Followers: ".concat(gitObj.followers);
  url.href = gitObj.url;
  ...
  cardInfo.classList.add('card-info'); // cardInfo.appendChild(userName);
...
var myURL = 'https://api.github.com/users/beatlesm'; // grabTheData(myURL);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","GitHubCard/index.js"], null)
//# sourceMappingURL=/GitHubCard.b6038f8e.js.map