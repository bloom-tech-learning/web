...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"data/articleData.js":[function(require,module,exports) {
"use strict";
...
var articleData = [{
  ...
  title: 'Professional JavaScript Development in 2021',
  date: 'Jan 1st, 2019',
...
var _default = articleData;
exports.default = _default;
},{}],"components/Article.js":[function(require,module,exports) {
"use strict";

var _articleData = _interopRequireDefault(require("../data/articleData"));
...
function articleMaker(data) {
  ...
  paragraphs.innerHTML = " \n    <div>   \n      <div>".concat(data.firstParagraph, "</div>\n      <div>").concat(data.secondParagraph, "</div>\n      <div>").concat(data.thirdParagraph, "<div>\n    </div>");
...
var testArticle = articleMaker(_articleData.default);
...
var newData = addArticle(_articleData.default, newAddelement); // console.log('articleData: ', newData);

var articleElements = _articleData.default.map(function (elem) {
  return articleMaker(elem);
}); // console.log(articleElements);


articleElements.forEach(function (elemToAdd) {
  articles.appendChild(elemToAdd);
});
},{"../data/articleData":"data/articleData.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
