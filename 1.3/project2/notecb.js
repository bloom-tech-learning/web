...
// Callback function is passed into other functions as arguments
...
// it must iterate through every single item in an array without stopping 
// does not need a return 

// cityData.forEach(function(x, y){
//   console.log(x.city);
//   console.log(y);
// });
...
// bigPopCities = bigPops.map(function(item){
//   return item.city;
// });
