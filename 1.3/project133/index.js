...
Baby.prototype.poop = function () {
  Person.prototype.poop(this); 
};
Baby.prototype.eat = function (someFood) {
  Person.prototype.eat(this, someFood);
}

// const myBaby = Baby(new Person('Lucy', 4), 'Lego trains');

/* 
  TASK 4
  In your own words explain the four principles for the "this" keyword below:
  1. Window binding - no context for the 'this';
  2. Implicit binding - objects with methods when the function is invoked, look to the left of the dot that's what 'this' refers to.
